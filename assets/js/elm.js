...
var _user$project$Phoenix$pushSocket_ = F4(
	function (endpoint, message, maybeSelfCb, state) {
		...
		if (_p16.ctor === 'Nothing') {
			...
			return A2(
				_user$project$Phoenix_Internal_Helpers_ops['<&>'],
				A2(_user$project$Phoenix_Internal_Socket$push, message, _p18),
				function (maybeRef) {
					var _p17 = maybeRef;
						...
						return _elm_lang$core$Task$succeed(
							A3(
								...
								A3(
									...
									endpoint,
									_user$project$Phoenix_Internal_Socket$increaseRef(_p18),
									state)));
					}
				});
		}
...
var _user$project$Phoenix$pushSocket = F4(
	function (endpoint, message, selfCb, state) {
		...
		if (_p20.ctor === 'Nothing') {
			...
			var _p25 = _p20._0;
			var _p21 = A3(_user$project$Phoenix_Internal_Channel$get, endpoint, message.topic, state.channels);
			if (_p21.ctor === 'Nothing') {
				...
				if (_p23.ctor === 'Joined') {
					return A2(
						_user$project$Phoenix_Internal_Helpers_ops['<&>'],
						A2(_user$project$Phoenix_Internal_Socket$push, message, _p25),
...
var _user$project$Phoenix$processQueue = F3(
	function (endpoint, messages, state) {
		...
		if (_p26.ctor === '[]') {
			...
			return A2(
				_user$project$Phoenix_Internal_Helpers_ops['<&>'],
				A4(_user$project$Phoenix$pushSocket, endpoint, _p26._0._0, _p26._0._1, state),
				A2(_user$project$Phoenix$processQueue, endpoint, _p26._1));
		}
	});
...
var _user$project$Phoenix$subMap = F2(
	function (func, sub) {
		...
		return A2(
			...
			A2(_user$project$Phoenix_Socket$map, func, _p30._0),
			A2(
				_elm_lang$core$List$map,
...
var _user$project$Phoenix$cmdMap = F2(
	function (func, cmd) {
		...
		return A2(
			...
			_p31._0,
			A2(_user$project$Phoenix_Push$map, func, _p31._1));
	});
...
var _user$project$Phoenix$sendPushsHelp = F2(
	function (cmds, state) {
		...
		if (_p32.ctor === '[]') {
			...
			var _p33 = _p32._0._1;
			var message = _user$project$Phoenix_Internal_Message$fromPush(_p33);
			return A2(
				_user$project$Phoenix_Internal_Helpers_ops['<&>'],
				A4(
					...
					message,
					_elm_lang$core$Maybe$Just(
						_user$project$Phoenix$PushResponse(_p33)),
					state),
				_user$project$Phoenix$sendPushsHelp(_p32._1));
		}
	});
...
var _user$project$Phoenix$sendJoinHelper = F3(
	function (endpoint, channels, state) {
		...
		if (_p45.ctor === '[]') {
			...
			var _p46 = _p45._0;
			var newChannel = A2(_user$project$Phoenix_Internal_Channel$updateState, _user$project$Phoenix_Internal_Channel$Joining, _p46);
			var newChannels = A4(_user$project$Phoenix_Internal_Helpers$insertIn, endpoint, _p46.channel.topic, newChannel, state.channels);
			var message = _user$project$Phoenix_Internal_Channel$joinMessage(_p46);
			var selfCb = A3(_user$project$Phoenix$ChannelJoinReply, endpoint, _p46.channel.topic, _p46.state);
			return A2(
				_user$project$Phoenix_Internal_Helpers_ops['<&>'],
				A4(
				...
				function (newState) {
					return A3(_user$project$Phoenix$sendJoinHelper, endpoint, _p45._1, newState);
				});
		}
	});
var _user$project$Phoenix$handlePhoenixMessage = F4(
	function (router, endpoint, message, state) {
		...
		switch (_p47) {
			case 'presence_state':
				var _p48 = A3(_user$project$Phoenix_Internal_Helpers$getIn, endpoint, message.topic, state.channels);
				if (_p48.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p52 = _p48._0;
					var newPresenceState = function () {
						var _p49 = _user$project$Phoenix_Internal_Presence$decodePresenceState(message.payload);
						if (_p49.ctor === 'Ok') {
							return _p49._0;
						} else {
					...
					var updatedChannel = A2(_user$project$Phoenix_Internal_Channel$updatePresenceState, newPresenceState, _p52);
					var updatedChannels = A4(_user$project$Phoenix_Internal_Helpers$insertIn, endpoint, _p52.channel.topic, updatedChannel, state.channels);
			...
			case 'presence_diff':
				var _p53 = A3(_user$project$Phoenix_Internal_Helpers$getIn, endpoint, message.topic, state.channels);
				if (_p53.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p61 = _p53._0;
					var diffResult = function () {
						var _p54 = _user$project$Phoenix_Internal_Presence$decodePresenceDiff(message.payload);
						if (_p54.ctor === 'Ok') {
							var _p55 = _p54._0;
							var newState = A2(_user$project$Phoenix_Internal_Presence$syncPresenceDiff, _p55, _p61.presenceState);
							return {
								newState: newState,
					...
					var updatedChannel = A2(_user$project$Phoenix_Internal_Channel$updatePresenceState, diffResult.newState, _p61);
					var updatedChannels = A4(_user$project$Phoenix_Internal_Helpers$insertIn, endpoint, _p61.channel.topic, updatedChannel, state.channels);
					var sendToApp = function () {
							...
							var sendOnLeaves = function () {
								...
								if ((_p58._0.ctor === 'Just') && (_p58._1.ctor === 'Just')) {
									return A2(
										...
										router,
										_p58._0._0(
											_user$project$Phoenix_Internal_Presence$getPresenceState(_p58._1._0)));
								} else {
									return _elm_lang$core$Task$succeed(
										{ctor: '_Tuple0'});
								}
							...
							var sendOnJoins = function () {
								...
								if ((_p59._0.ctor === 'Just') && (_p59._1.ctor === 'Just')) {
									return A2(
										...
										router,
										_p59._0._0(
											_user$project$Phoenix_Internal_Presence$getPresenceState(_p59._1._0)));
								} else {
									return _elm_lang$core$Task$succeed(
										{ctor: '_Tuple0'});
								}
			...
			case 'phx_error':
				var _p62 = A3(_user$project$Phoenix_Internal_Helpers$getIn, endpoint, message.topic, state.channels);
				if (_p62.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					var _p64 = _p62._0;
					...
					var newChannel = A2(_user$project$Phoenix_Internal_Channel$updateState, _user$project$Phoenix_Internal_Channel$Errored, _p64);
					return A2(
						_user$project$Phoenix_Internal_Helpers_ops['&>'],
						sendToApp,
						A3(
...
var _user$project$Phoenix$open = F2(
	function (socket, router) {
		var onMessage = F2(
			function (_p67, msg) {
				var _p68 = _user$project$Phoenix_Internal_Message$decode(msg);
				if (_p68.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform$sendToSelf,
						router,
						A2(
							...
							A2(_user$project$Phoenix_Internal_Socket$debugLogMessage, socket, _p68._0)));
				} else {
					return _elm_lang$core$Task$succeed(
						{ctor: '_Tuple0'});
				}
	...
	function (router, backoff, _p69) {
		...
		var badOpen = function (details) {
			return A2(
				_elm_lang$core$Platform$sendToSelf,
				router,
				A2(_user$project$Phoenix$BadOpen, _p71.endpoint, details));
		};
		var goodOpen = function (ws) {
			return A2(
				_elm_lang$core$Platform$sendToSelf,
				router,
				A2(_user$project$Phoenix$GoodOpen, _p71.endpoint, ws));
		};
		var actuallyAttemptOpen = A2(
			...
			A2(
				_elm_lang$core$Task$andThen,
				goodOpen,
				A2(_user$project$Phoenix$open, _p70, router)));
...
var _user$project$Phoenix$onSelfMsg = F3(
	function (router, selfMsg, state) {
		...
		switch (_p72.ctor) {
			case 'GoodOpen':
				var _p76 = _p72._0;
				var _p73 = A2(_user$project$Phoenix_Internal_Socket$get, _p76, state.sockets);
				if (_p73.ctor === 'Just') {
					var _p75 = _p73._0;
					var state_ = A3(
						_user$project$Phoenix$insertSocket,
						_p76,
						A2(_user$project$Phoenix_Internal_Socket$connected, _p72._1, _p75),
						state);
					var notifyOnOpen = A2(_user$project$Phoenix$maybeNotifyApp, router, _p75.socket.onOpen);
					...
					return A2(
						...
						A2(
							_user$project$Phoenix_Internal_Helpers_ops['&>'],
							notifyOnOpen,
							A3(_user$project$Phoenix$heartbeat, router, _p76, state_)),
						_user$project$Phoenix$rejoinAllChannels(_p76));
				} else {
					return _elm_lang$core$Task$succeed(state);
				}
			case 'BadOpen':
				...
				if (_p77.ctor === 'Nothing') {
					...
					var newState = function (pid) {
						return A3(
							...
							_p82,
							A3(_user$project$Phoenix_Internal_Socket$opening, backoffIteration, pid, _p80),
							state);
					};
					...
					return A2(
						_elm_lang$core$Task$map,
						newState,
						A3(_user$project$Phoenix$attemptOpen, router, backoff, _p80));
				}
			case 'Die':
				var _p88 = _p72._0;
				var _p87 = _p72._1;
				...
				if (_p83.ctor === 'Nothing') {
					...
					var _p85 = _p83._0;
					var notifyOnNormalClose = _elm_lang$core$Native_Utils.eq(_p87.code, 1000) ? A2(_user$project$Phoenix$maybeNotifyApp, router, _p86.onNormalClose) : _elm_lang$core$Task$succeed(
						{ctor: '_Tuple0'});
					var notifyOnClose = A2(
						...
						A2(
							...
							_p86.onClose));
					var getNewState = A3(_user$project$Phoenix$handleChannelDisconnect, router, _p88, state);
					var backoffIteration = function () {
					...
					var finalNewState = function (pid) {
						return A2(
							...
							A2(
								_user$project$Phoenix$updateSocket,
								_p88,
								A3(_user$project$Phoenix_Internal_Socket$opening, backoffIteration, pid, _p85)),
							getNewState);
					};
					...
					return A2(
						...
						A2(
							...
							A3(_user$project$Phoenix$attemptOpen, router, backoff, _p85)));
				}
			case 'Receive':
				var _p90 = _p72._1;
				var _p89 = _p72._0;
				return A2(
					...
					A2(
						_user$project$Phoenix_Internal_Helpers_ops['&>'],
						A4(_user$project$Phoenix$dispatchMessage, router, _p89, _p90, state.channels),
						A2(
							_elm_lang$core$Task$map,
							function (selfCbs) {
								return A2(_user$project$Phoenix$updateSelfCallbacks, selfCbs, state);
							},
							A4(_user$project$Phoenix$handleSelfcallback, router, _p89, _p90, state.selfCallbacks))),
					A3(_user$project$Phoenix$handlePhoenixMessage, router, _p89, _p90));
			case 'ChannelJoinReply':
				return A2(
					...
					A6(_user$project$Phoenix$handleChannelJoinReply, router, _p72._0, _p72._1, _p72._3, _p72._2, state.channels));
			case 'JoinChannel':
				var _p94 = _p72._1;
				var _p93 = _p72._0;
				...
				if (_p91.ctor === 'Nothing') {
					...
					if (_p92.ctor === 'Connected') {
						return A4(
							_user$project$Phoenix$pushSocket_,
							_p93,
							_user$project$Phoenix_Internal_Channel$joinMessage(_p94),
							_elm_lang$core$Maybe$Just(
								A3(_user$project$Phoenix$ChannelJoinReply, _p93, _p94.channel.topic, _p94.state)),
							state);
					} else {
						return _elm_lang$core$Task$succeed(state);
					}
				...
				if (_p95.ctor === 'Nothing') {
					...
					if (_p96.ctor === 'Joined') {
						return A4(
							_user$project$Phoenix$pushSocket_,
							_p97,
							_user$project$Phoenix_Internal_Channel$leaveMessage(_p98),
							_elm_lang$core$Maybe$Just(
								A2(_user$project$Phoenix$ChannelLeaveReply, _p97, _p98)),
							state);
					} else {
						return _elm_lang$core$Task$succeed(state);
					}
			...
			case 'ChannelLeaveReply':
				...
				var _p99 = _user$project$Phoenix_Internal_Helpers$decodeReplyPayload(_p72._2.payload);
			...
			case 'SendHeartbeat':
				return A3(_user$project$Phoenix$heartbeat, router, _p72._0, state);
			case 'GoodJoin':
				var _p106 = _p72._1;
				var _p105 = _p72._0;
				var _p104 = A3(_user$project$Phoenix_Internal_Helpers$getIn, _p105, _p106, state.channelQueues);
				if (_p104.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					return A2(
						_elm_lang$core$Task$map,
						A2(_user$project$Phoenix$removeChannelQueue, _p105, _p106),
						A3(_user$project$Phoenix$processQueue, _p105, _p104._0, state));
				}
			case 'PushResponse':
				var _p111 = _p72._0;
				var _p107 = _user$project$Phoenix_Internal_Helpers$decodeReplyPayload(_p72._1.payload);
...
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {contactList: a, search: b, route: c, contact: d, flags: e};
	});
...
var _user$project$Model$initialModel = F2(
	function (flags, route) {
		return {contactList: _user$project$Model$NotRequested, search: '', route: route, contact: _user$project$Model$NotRequested, flags: flags};
	});
