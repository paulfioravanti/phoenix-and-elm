defmodule PhoenixAndElm.AddressBookTest do
  ...
  describe "contacts" do
    ...
    @update_attrs %{birth_date: ~D[2011-05-18], email: "some updated email", first_name: "some updated first_name", gender: 43, headline: "some updated headline", last_name: "some updated last_name", location: "some updated location", phone_number: "some updated phone_number", picture: "some updated picture"}
    @invalid_attrs %{birth_date: nil, email: nil, first_name: nil, gender: nil, headline: nil, last_name: nil, location: nil, phone_number: nil, picture: nil}
    ...
    test "update_contact/2 with valid data updates the contact" do
      contact = contact_fixture()
      assert {:ok, contact} = AddressBook.update_contact(contact, @update_attrs)
